...
if(isset($_POST['submited'])){
    ...
    if(in_array($ekstensi_foto, $ekstensi_diperbolehkan_foto) === true){
        if($ukuran_foto < 10440070){
            ...
            $sql = "INSERT into barang (id_barang,id_kategori,id_barcode,nama_barang,merk,harga_beli,harga_jual,stok,satuan_barang,photo,tgl_input) VALUES ('','$kategori','$id','$nama','$merk','$beli','$jual','$stok','$satuan','$nama_foto','$tgl')";
